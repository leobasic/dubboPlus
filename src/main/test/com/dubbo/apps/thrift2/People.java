...
public class People implements org.apache.thrift.TBase<People, People._Fields>, java.io.Serializable, Cloneable {
  ...
  public People setPrice(double price) {
    this.price = price;
    setPriceIsSet(true);
    return this;
  }
  ...
  public int compareTo(People other) {
    ...
    People typedOther = (People)other;
