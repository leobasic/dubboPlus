 ...
 * @date 2016年6月14日 下午1:55:23
 */
public class ThriftNativeProtocol extends AbstractProtocol {
    ...
    public <T> Exporter<T> export( Invoker<T> invoker ) throws RpcException {
        ...
        // 只能使用 thriftx codec
        URL url = invoker.getUrl().addParameter(Constants.CODEC_KEY, ThriftNativeCodec.NAME);
        // find server.
    ...
    private ExchangeClient initClient(URL url) {
        ...
        url = url.addParameter( Constants.CODEC_KEY, ThriftNativeCodec.NAME );
