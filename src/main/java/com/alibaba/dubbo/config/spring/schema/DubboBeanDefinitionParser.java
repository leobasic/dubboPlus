...
public class DubboBeanDefinitionParser implements BeanDefinitionParser {
    ...
    /**
     * <dubbo:reference timeout="60000" retries="0" check="false"
    ...
    private static BeanDefinition parse(Element element, ParserContext parserContext, Class<?> beanClass, boolean required) {
        ...
        if (ProtocolConfig.class.equals(beanClass)) {
            ...
            //新增原生thrift支持
            String thrift_native = element.getAttribute("thrift_native");
            if (thrift_native != null && thrift_native.length()>0 )
            {
            	beanDefinition.getPropertyValues().addPropertyValue("thrift_native", Boolean.valueOf(thrift_native) );
            }
